...
pub struct LoginRequest {
    ...
    // @@protoc_insertion_point(field:hbb.LoginRequest.my_platform)
    pub my_platform: ::std::string::String,
    // @@protoc_insertion_point(field:hbb.LoginRequest.hwid)
    pub hwid: ::bytes::Bytes,
    // message oneof groups
...
impl LoginRequest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "hwid",
            |m: &LoginRequest| { &m.hwid },
            |m: &mut LoginRequest| { &mut m.hwid },
        ));
...
impl ::protobuf::Message for LoginRequest {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.hwid.is_empty() {
            my_size += ::protobuf::rt::bytes_size(14, &self.hwid);
        }
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
...
pub struct Auth2FA {
    ...
    // @@protoc_insertion_point(field:hbb.Auth2FA.hwid)
    pub hwid: ::bytes::Bytes,
    // special fields
...
impl ::protobuf::Message for Auth2FA {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.hwid.is_empty() {
            my_size += ::protobuf::rt::bytes_size(2, &self.hwid);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
...
pub struct LoginResponse {
    // message fields
    // @@protoc_insertion_point(field:hbb.LoginResponse.enable_trusted_devices)
...
impl LoginResponse {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            ...
            |m: &LoginResponse| { &m.enable_trusted_devices },
            |m: &mut LoginResponse| { &mut m.enable_trusted_devices },
        ));
...
impl ::protobuf::Message for LoginResponse {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                24 => {
                    self.enable_trusted_devices = is.read_bool()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.enable_trusted_devices != false {
            my_size += 1 + 1;
        }
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.enable_trusted_devices != false {
            os.write_bool(3, self.enable_trusted_devices)?;
        }
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
                &login_response::Union::Error(ref v) => {
    ...
    fn clear(&mut self) {
        self.union = ::std::option::Option::None;
        self.union = ::std::option::Option::None;
        self.enable_trusted_devices = false;
        self.special_fields.clear();
    }
...
pub struct Clipboard {
    ...
    pub height: i32,
    // @@protoc_insertion_point(field:hbb.Clipboard.format)
    pub format: ::protobuf::EnumOrUnknown<ClipboardFormat>,
    // @@protoc_insertion_point(field:hbb.Clipboard.special_name)
...
impl ::protobuf::Message for Clipboard {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.format != ::protobuf::EnumOrUnknown::new(ClipboardFormat::Text) {
    ...
    fn clear(&mut self) {
        ...
        self.width = 0;
        self.height = 0;
        self.format = ::protobuf::EnumOrUnknown::new(ClipboardFormat::Text);
...
// @@protoc_insertion_point(message:hbb.MultiClipboards)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct MultiClipboards {
    // message fields
    // @@protoc_insertion_point(field:hbb.MultiClipboards.clipboards)
    pub clipboards: ::std::vec::Vec<Clipboard>,
    // special fields
    // @@protoc_insertion_point(special_field:hbb.MultiClipboards.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl ::protobuf::Message for MultiClipboards {
    const NAME: &'static str = "MultiClipboards";
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    self.clipboards.push(is.read_message()?);
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
...
impl ::protobuf::MessageFull for MultiClipboards {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("MultiClipboards").unwrap()).clone()
    }
}

impl ::std::fmt::Display for MultiClipboards {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}
...
// @@protoc_insertion_point(message:hbb.FileRename)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct FileRename {
    // message fields
    // @@protoc_insertion_point(field:hbb.FileRename.id)
    pub id: i32,
    // @@protoc_insertion_point(field:hbb.FileRename.path)
    pub path: ::std::string::String,
    // @@protoc_insertion_point(field:hbb.FileRename.new_name)
    pub new_name: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:hbb.FileRename.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}

impl<'a> ::std::default::Default for &'a FileRename {
    fn default() -> &'a FileRename {
        <FileRename as ::protobuf::Message>::default_instance()
    }
}

impl FileRename {
    pub fn new() -> FileRename {
        ::std::default::Default::default()
    }
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "id",
            |m: &FileRename| { &m.id },
            |m: &mut FileRename| { &mut m.id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "path",
            |m: &FileRename| { &m.path },
            |m: &mut FileRename| { &mut m.path },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "new_name",
            |m: &FileRename| { &m.new_name },
            |m: &mut FileRename| { &mut m.new_name },
        ));
        ::protobuf::reflect::GeneratedMessageDescriptorData::new_2::<FileRename>(
            "FileRename",
            fields,
            oneofs,
        )
...
impl ::protobuf::Message for FileRename {
    const NAME: &'static str = "FileRename";
    ...
    fn default_instance() -> &'static FileRename {
        static instance: FileRename = FileRename {
            id: 0,
            path: ::std::string::String::new(),
...
impl ::protobuf::MessageFull for FileRename {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("FileRename").unwrap()).clone()
    }
}

impl ::std::fmt::Display for FileRename {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for FileRename {
    type RuntimeType = ::protobuf::reflect::rt::RuntimeTypeMessage<Self>;
}
...
impl FileAction {
    ...
    pub fn rename(&self) -> &FileRename {
        match self.union {
            ::std::option::Option::Some(file_action::Union::Rename(ref v)) => v,
            _ => <FileRename as ::protobuf::Message>::default_instance(),
        }
    }
    ...
    pub fn has_rename(&self) -> bool {
        match self.union {
            ::std::option::Option::Some(file_action::Union::Rename(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_rename(&mut self, v: FileRename) {
        self.union = ::std::option::Option::Some(file_action::Union::Rename(v))
    }

    // Mutable pointer to the field.
    pub fn mut_rename(&mut self) -> &mut FileRename {
        if let ::std::option::Option::Some(file_action::Union::Rename(_)) = self.union {
        } else {
            self.union = ::std::option::Option::Some(file_action::Union::Rename(FileRename::new()));
        }
        match self.union {
            ::std::option::Option::Some(file_action::Union::Rename(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_rename(&mut self) -> FileRename {
        if self.has_rename() {
            match self.union.take() {
                ::std::option::Option::Some(file_action::Union::Rename(v)) => v,
                _ => panic!(),
            }
        } else {
            FileRename::new()
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, FileRename>(
            "rename",
            FileAction::has_rename,
            FileAction::rename,
            FileAction::mut_rename,
            FileAction::set_rename,
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                82 => {
                    self.union = ::std::option::Option::Some(file_action::Union::Rename(is.read_message()?));
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
                ...
                &file_action::Union::Rename(ref v) => {
                    let len = v.compute_size();
                    my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
                },
            };
...
pub mod file_action {
    ...
    pub enum Union {
        ...
        // @@protoc_insertion_point(oneof_field:hbb.FileAction.rename)
...
impl Message {
    ...
    pub fn multi_clipboards(&self) -> &MultiClipboards {
        match self.union {
            ::std::option::Option::Some(message::Union::MultiClipboards(ref v)) => v,
    ...
    pub fn has_multi_clipboards(&self) -> bool {
        match self.union {
            ::std::option::Option::Some(message::Union::MultiClipboards(..)) => true,
            _ => false,
        }
    }
    ...
    pub fn set_multi_clipboards(&mut self, v: MultiClipboards) {
        self.union = ::std::option::Option::Some(message::Union::MultiClipboards(v))
    }

    // Mutable pointer to the field.
    pub fn mut_multi_clipboards(&mut self) -> &mut MultiClipboards {
        if let ::std::option::Option::Some(message::Union::MultiClipboards(_)) = self.union {
        } else {
            self.union = ::std::option::Option::Some(message::Union::MultiClipboards(MultiClipboards::new()));
        }
        match self.union {
            ::std::option::Option::Some(message::Union::MultiClipboards(ref mut v)) => v,
            _ => panic!(),
        }
    }
    ...
    pub fn take_multi_clipboards(&mut self) -> MultiClipboards {
        if self.has_multi_clipboards() {
            match self.union.take() {
                ::std::option::Option::Some(message::Union::MultiClipboards(v)) => v,
                _ => panic!(),
            }
        } else {
            MultiClipboards::new()
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                226 => {
                    self.union = ::std::option::Option::Some(message::Union::MultiClipboards(is.read_message()?));
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
                ...
                &message::Union::MultiClipboards(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
                },
            };
...
pub mod message {
    ...
    pub enum Union {
        ...
        // @@protoc_insertion_point(oneof_field:hbb.Message.multi_clipboards)
...
#[derive(Clone,Copy,PartialEq,Eq,Debug,Hash)]
// @@protoc_insertion_point(enum:hbb.ClipboardFormat)
pub enum ClipboardFormat {
    // @@protoc_insertion_point(enum_value:hbb.ClipboardFormat.Text)
    Text = 0,
    // @@protoc_insertion_point(enum_value:hbb.ClipboardFormat.Rtf)
    Rtf = 1,
    // @@protoc_insertion_point(enum_value:hbb.ClipboardFormat.Html)
    Html = 2,
    // @@protoc_insertion_point(enum_value:hbb.ClipboardFormat.ImageRgba)
    ImageRgba = 21,
    // @@protoc_insertion_point(enum_value:hbb.ClipboardFormat.ImagePng)
    ImagePng = 22,
    // @@protoc_insertion_point(enum_value:hbb.ClipboardFormat.ImageSvg)
    ImageSvg = 23,
    // @@protoc_insertion_point(enum_value:hbb.ClipboardFormat.Special)
    Special = 31,
}

impl ::protobuf::Enum for ClipboardFormat {
    const NAME: &'static str = "ClipboardFormat";
    ...
    fn from_str(str: &str) -> ::std::option::Option<ClipboardFormat> {
        match str {
            "Text" => ::std::option::Option::Some(ClipboardFormat::Text),
            "Rtf" => ::std::option::Option::Some(ClipboardFormat::Rtf),
            "Html" => ::std::option::Option::Some(ClipboardFormat::Html),
            "ImageRgba" => ::std::option::Option::Some(ClipboardFormat::ImageRgba),
            "ImagePng" => ::std::option::Option::Some(ClipboardFormat::ImagePng),
            "ImageSvg" => ::std::option::Option::Some(ClipboardFormat::ImageSvg),
            "Special" => ::std::option::Option::Some(ClipboardFormat::Special),
            _ => ::std::option::Option::None
        }
    }

    const VALUES: &'static [ClipboardFormat] = &[
...
impl ::protobuf::EnumFull for ClipboardFormat {
    fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::EnumDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().enum_by_package_relative_name("ClipboardFormat").unwrap()).clone()
    }

    fn descriptor(&self) -> ::protobuf::reflect::EnumValueDescriptor {
        let index = match self {
            ClipboardFormat::Text => 0,
            ClipboardFormat::Rtf => 1,
            ClipboardFormat::Html => 2,
            ClipboardFormat::ImageRgba => 3,
            ClipboardFormat::ImagePng => 4,
            ClipboardFormat::ImageSvg => 5,
            ClipboardFormat::Special => 6,
        };
        Self::enum_descriptor().value_by_index(index)
    }
}
...
impl ClipboardFormat {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new::<ClipboardFormat>("ClipboardFormat")
    }
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x04hwid\x18\x0e\x20\x01(\x0cR\x04hwidB\x07\n\x05union\"1\n\x07Auth2FA\
    \x12\x12\n\x04code\x18\x01\x20\x01(\tR\x04code\x12\x12\n\x04hwid\x18\x02\
    \x20\x01(\x0cR\x04hwid\"!\n\x0bChatMessage\x12\x12\n\x04text\x18\x01\x20\
    \x01(\tR\x04text\"-\n\x08Features\x12!\n\x0cprivacy_mode\x18\x01\x20\x01\
    (\x08R\x0bprivacyMode\"l\n\x0cCodecAbility\x12\x10\n\x03vp8\x18\x01\x20\
    \x01(\x08R\x03vp8\x12\x10\n\x03vp9\x18\x02\x20\x01(\x08R\x03vp9\x12\x10\
    \n\x03av1\x18\x03\x20\x01(\x08R\x03av1\x12\x12\n\x04h264\x18\x04\x20\x01\
    (\x08R\x04h264\x12\x12\n\x04h265\x18\x05\x20\x01(\x08R\x04h265\"\x86\x01\
    \n\x11SupportedEncoding\x12\x12\n\x04h264\x18\x01\x20\x01(\x08R\x04h264\
    \x12\x12\n\x04h265\x18\x02\x20\x01(\x08R\x04h265\x12\x10\n\x03vp8\x18\
    \x03\x20\x01(\x08R\x03vp8\x12\x10\n\x03av1\x18\x04\x20\x01(\x08R\x03av1\
    \x12%\n\x04i444\x18\x05\x20\x01(\x0b2\x11.hbb.CodecAbilityR\x04i444\"\
    \xfc\x03\n\x08PeerInfo\x12\x1a\n\x08username\x18\x01\x20\x01(\tR\x08user\
    name\x12\x1a\n\x08hostname\x18\x02\x20\x01(\tR\x08hostname\x12\x1a\n\x08\
    platform\x18\x03\x20\x01(\tR\x08platform\x12,\n\x08displays\x18\x04\x20\
    \x03(\x0b2\x10.hbb.DisplayInfoR\x08displays\x12'\n\x0fcurrent_display\
    \x18\x05\x20\x01(\x05R\x0ecurrentDisplay\x12\x1f\n\x0bsas_enabled\x18\
    \x06\x20\x01(\x08R\nsasEnabled\x12\x18\n\x07version\x18\x07\x20\x01(\tR\
    \x07version\x12)\n\x08features\x18\t\x20\x01(\x0b2\r.hbb.FeaturesR\x08fe\
    atures\x122\n\x08encoding\x18\n\x20\x01(\x0b2\x16.hbb.SupportedEncodingR\
    \x08encoding\x12;\n\x0bresolutions\x18\x0b\x20\x01(\x0b2\x19.hbb.Support\
    edResolutionsR\x0bresolutions\x12-\n\x12platform_additions\x18\x0c\x20\
    \x01(\tR\x11platformAdditions\x12?\n\x10windows_sessions\x18\r\x20\x01(\
    \x0b2\x14.hbb.WindowsSessionsR\x0fwindowsSessions\"6\n\x0eWindowsSession\
    \x12\x10\n\x03sid\x18\x01\x20\x01(\rR\x03sid\x12\x12\n\x04name\x18\x02\
    \x20\x01(\tR\x04name\"\x94\x01\n\rLoginResponse\x12\x16\n\x05error\x18\
    \x01\x20\x01(\tH\0R\x05error\x12,\n\tpeer_info\x18\x02\x20\x01(\x0b2\r.h\
    bb.PeerInfoH\0R\x08peerInfo\x124\n\x16enable_trusted_devices\x18\x03\x20\
    \x01(\x08R\x14enableTrustedDevicesB\x07\n\x05union\"(\n\x10TouchScaleUpd\
    ate\x12\x14\n\x05scale\x18\x01\x20\x01(\x05R\x05scale\"+\n\rTouchPanStar\
    t\x12\x0c\n\x01x\x18\x01\x20\x01(\x05R\x01x\x12\x0c\n\x01y\x18\x02\x20\
    \x01(\x05R\x01y\",\n\x0eTouchPanUpdate\x12\x0c\n\x01x\x18\x01\x20\x01(\
    \x05R\x01x\x12\x0c\n\x01y\x18\x02\x20\x01(\x05R\x01y\")\n\x0bTouchPanEnd\
    \x12\x0c\n\x01x\x18\x01\x20\x01(\x05R\x01x\x12\x0c\n\x01y\x18\x02\x20\
    \x01(\x05R\x01y\"\xe7\x01\n\nTouchEvent\x12:\n\x0cscale_update\x18\x01\
    \x20\x01(\x0b2\x15.hbb.TouchScaleUpdateH\0R\x0bscaleUpdate\x121\n\tpan_s\
    tart\x18\x02\x20\x01(\x0b2\x12.hbb.TouchPanStartH\0R\x08panStart\x124\n\
    \npan_update\x18\x03\x20\x01(\x0b2\x13.hbb.TouchPanUpdateH\0R\tpanUpdate\
    \x12+\n\x07pan_end\x18\x04\x20\x01(\x0b2\x10.hbb.TouchPanEndH\0R\x06panE\
    ndB\x07\n\x05union\"\x80\x01\n\x12PointerDeviceEvent\x122\n\x0btouch_eve\
    nt\x18\x01\x20\x01(\x0b2\x0f.hbb.TouchEventH\0R\ntouchEvent\x12-\n\tmodi\
    fiers\x18\x02\x20\x03(\x0e2\x0f.hbb.ControlKeyR\tmodifiersB\x07\n\x05uni\
    on\"k\n\nMouseEvent\x12\x12\n\x04mask\x18\x01\x20\x01(\x05R\x04mask\x12\
    \x0c\n\x01x\x18\x02\x20\x01(\x11R\x01x\x12\x0c\n\x01y\x18\x03\x20\x01(\
    \x11R\x01y\x12-\n\tmodifiers\x18\x04\x20\x03(\x0e2\x0f.hbb.ControlKeyR\t\
    modifiers\"\xb4\x02\n\x08KeyEvent\x12\x12\n\x04down\x18\x01\x20\x01(\x08\
    R\x04down\x12\x14\n\x05press\x18\x02\x20\x01(\x08R\x05press\x122\n\x0bco\
    ntrol_key\x18\x03\x20\x01(\x0e2\x0f.hbb.ControlKeyH\0R\ncontrolKey\x12\
    \x12\n\x03chr\x18\x04\x20\x01(\rH\0R\x03chr\x12\x1a\n\x07unicode\x18\x05\
    \x20\x01(\rH\0R\x07unicode\x12\x12\n\x03seq\x18\x06\x20\x01(\tH\0R\x03se\
    q\x12'\n\x0ewin2win_hotkey\x18\x07\x20\x01(\rH\0R\rwin2winHotkey\x12-\n\
    \tmodifiers\x18\x08\x20\x03(\x0e2\x0f.hbb.ControlKeyR\tmodifiers\x12%\n\
    \x04mode\x18\t\x20\x01(\x0e2\x11.hbb.KeyboardModeR\x04modeB\x07\n\x05uni\
    on\"\x8a\x01\n\nCursorData\x12\x0e\n\x02id\x18\x01\x20\x01(\x04R\x02id\
    \x12\x12\n\x04hotx\x18\x02\x20\x01(\x11R\x04hotx\x12\x12\n\x04hoty\x18\
    \x03\x20\x01(\x11R\x04hoty\x12\x14\n\x05width\x18\x04\x20\x01(\x05R\x05w\
    idth\x12\x16\n\x06height\x18\x05\x20\x01(\x05R\x06height\x12\x16\n\x06co\
    lors\x18\x06\x20\x01(\x0cR\x06colors\",\n\x0eCursorPosition\x12\x0c\n\
    \x01x\x18\x01\x20\x01(\x11R\x01x\x12\x0c\n\x01y\x18\x02\x20\x01(\x11R\
    \x01y\"8\n\x04Hash\x12\x12\n\x04salt\x18\x01\x20\x01(\tR\x04salt\x12\x1c\
    \n\tchallenge\x18\x02\x20\x01(\tR\tchallenge\"\xc0\x01\n\tClipboard\x12\
    \x1a\n\x08compress\x18\x01\x20\x01(\x08R\x08compress\x12\x18\n\x07conten\
    t\x18\x02\x20\x01(\x0cR\x07content\x12\x14\n\x05width\x18\x03\x20\x01(\
    \x05R\x05width\x12\x16\n\x06height\x18\x04\x20\x01(\x05R\x06height\x12,\
    \n\x06format\x18\x05\x20\x01(\x0e2\x14.hbb.ClipboardFormatR\x06format\
    \x12!\n\x0cspecial_name\x18\x06\x20\x01(\tR\x0bspecialName\"A\n\x0fMulti\
    Clipboards\x12.\n\nclipboards\x18\x01\x20\x03(\x0b2\x0e.hbb.ClipboardR\n\
    clipboards\"\xa3\x01\n\tFileEntry\x12,\n\nentry_type\x18\x01\x20\x01(\
    \x0e2\r.hbb.FileTypeR\tentryType\x12\x12\n\x04name\x18\x02\x20\x01(\tR\
    \x04name\x12\x1b\n\tis_hidden\x18\x03\x20\x01(\x08R\x08isHidden\x12\x12\
    \n\x04size\x18\x04\x20\x01(\x04R\x04size\x12#\n\rmodified_time\x18\x05\
    \x20\x01(\x04R\x0cmodifiedTime\"]\n\rFileDirectory\x12\x0e\n\x02id\x18\
    \x01\x20\x01(\x05R\x02id\x12\x12\n\x04path\x18\x02\x20\x01(\tR\x04path\
    \x12(\n\x07entries\x18\x03\x20\x03(\x0b2\x0e.hbb.FileEntryR\x07entries\"\
    D\n\x07ReadDir\x12\x12\n\x04path\x18\x01\x20\x01(\tR\x04path\x12%\n\x0ei\
    nclude_hidden\x18\x02\x20\x01(\x08R\rincludeHidden\"Y\n\x0cReadAllFiles\
    \x12\x0e\n\x02id\x18\x01\x20\x01(\x05R\x02id\x12\x12\n\x04path\x18\x02\
    \x20\x01(\tR\x04path\x12%\n\x0einclude_hidden\x18\x03\x20\x01(\x08R\rinc\
    ludeHidden\"K\n\nFileRename\x12\x0e\n\x02id\x18\x01\x20\x01(\x05R\x02id\
    \x12\x12\n\x04path\x18\x02\x20\x01(\tR\x04path\x12\x19\n\x08new_name\x18\
    \x03\x20\x01(\tR\x07newName\"\xa6\x04\n\nFileAction\x12)\n\x08read_dir\
    \x18\x01\x20\x01(\x0b2\x0c.hbb.ReadDirH\0R\x07readDir\x122\n\x04send\x18\
    \x02\x20\x01(\x0b2\x1c.hbb.FileTransferSendRequestH\0R\x04send\x12;\n\
    \x07receive\x18\x03\x20\x01(\x0b2\x1f.hbb.FileTransferReceiveRequestH\0R\
    \x07receive\x12,\n\x06create\x18\x04\x20\x01(\x0b2\x12.hbb.FileDirCreate\
    H\0R\x06create\x123\n\nremove_dir\x18\x05\x20\x01(\x0b2\x12.hbb.FileRemo\
    veDirH\0R\tremoveDir\x126\n\x0bremove_file\x18\x06\x20\x01(\x0b2\x13.hbb\
    .FileRemoveFileH\0R\nremoveFile\x120\n\tall_files\x18\x07\x20\x01(\x0b2\
    \x11.hbb.ReadAllFilesH\0R\x08allFiles\x121\n\x06cancel\x18\x08\x20\x01(\
    \x0b2\x17.hbb.FileTransferCancelH\0R\x06cancel\x12H\n\x0csend_confirm\
    \x18\t\x20\x01(\x0b2#.hbb.FileTransferSendConfirmRequestH\0R\x0bsendConf\
    irm\x12)\n\x06rename\x18\n\x20\x01(\x0b2\x0f.hbb.FileRenameH\0R\x06renam\
    eB\x07\n\x05union\"$\n\x12FileTransferCancel\x12\x0e\n\x02id\x18\x01\x20\
    \x01(\x05R\x02id\"\xff\x01\n\x0cFileResponse\x12&\n\x03dir\x18\x01\x20\
    \x01(\x0b2\x12.hbb.FileDirectoryH\0R\x03dir\x12.\n\x05block\x18\x02\x20\
    \x01(\x0b2\x16.hbb.FileTransferBlockH\0R\x05block\x12.\n\x05error\x18\
    \x03\x20\x01(\x0b2\x16.hbb.FileTransferErrorH\0R\x05error\x12+\n\x04done\
    \x18\x04\x20\x01(\x0b2\x15.hbb.FileTransferDoneH\0R\x04done\x121\n\x06di\
    gest\x18\x05\x20\x01(\x0b2\x17.hbb.FileTransferDigestH\0R\x06digestB\x07\
    \n\x05union\"\xc1\x01\n\x12FileTransferDigest\x12\x0e\n\x02id\x18\x01\
    \x20\x01(\x05R\x02id\x12\x19\n\x08file_num\x18\x02\x20\x01(\x11R\x07file\
    Num\x12#\n\rlast_modified\x18\x03\x20\x01(\x04R\x0clastModified\x12\x1b\
    \n\tfile_size\x18\x04\x20\x01(\x04R\x08fileSize\x12\x1b\n\tis_upload\x18\
    \x05\x20\x01(\x08R\x08isUpload\x12!\n\x0cis_identical\x18\x06\x20\x01(\
    \x08R\x0bisIdentical\"\x89\x01\n\x11FileTransferBlock\x12\x0e\n\x02id\
    \x18\x01\x20\x01(\x05R\x02id\x12\x19\n\x08file_num\x18\x02\x20\x01(\x11R\
    \x07fileNum\x12\x12\n\x04data\x18\x03\x20\x01(\x0cR\x04data\x12\x1e\n\nc\
    ompressed\x18\x04\x20\x01(\x08R\ncompressed\x12\x15\n\x06blk_id\x18\x05\
    \x20\x01(\rR\x05blkId\"T\n\x11FileTransferError\x12\x0e\n\x02id\x18\x01\
    \x20\x01(\x05R\x02id\x12\x14\n\x05error\x18\x02\x20\x01(\tR\x05error\x12\
    \x19\n\x08file_num\x18\x03\x20\x01(\x11R\x07fileNum\"\x7f\n\x17FileTrans\
    ferSendRequest\x12\x0e\n\x02id\x18\x01\x20\x01(\x05R\x02id\x12\x12\n\x04\
    path\x18\x02\x20\x01(\tR\x04path\x12%\n\x0einclude_hidden\x18\x03\x20\
    \x01(\x08R\rincludeHidden\x12\x19\n\x08file_num\x18\x04\x20\x01(\x05R\
    \x07fileNum\"\x8b\x01\n\x1eFileTransferSendConfirmRequest\x12\x0e\n\x02i\
    d\x18\x01\x20\x01(\x05R\x02id\x12\x19\n\x08file_num\x18\x02\x20\x01(\x11\
    R\x07fileNum\x12\x14\n\x04skip\x18\x03\x20\x01(\x08H\0R\x04skip\x12\x1f\
    ...
    ferReceiveRequest\x12\x0e\n\x02id\x18\x01\x20\x01(\x05R\x02id\x12\x12\n\
    \x04path\x18\x02\x20\x01(\tR\x04path\x12$\n\x05files\x18\x03\x20\x03(\
    \x0b2\x0e.hbb.FileEntryR\x05files\x12\x19\n\x08file_num\x18\x04\x20\x01(\
    \x05R\x07fileNum\x12\x1d\n\ntotal_size\x18\x05\x20\x01(\x04R\ttotalSize\
    \"Q\n\rFileRemoveDir\x12\x0e\n\x02id\x18\x01\x20\x01(\x05R\x02id\x12\x12\
    \n\x04path\x18\x02\x20\x01(\tR\x04path\x12\x1c\n\trecursive\x18\x03\x20\
    \x01(\x08R\trecursive\"O\n\x0eFileRemoveFile\x12\x0e\n\x02id\x18\x01\x20\
    ...
    \x02\x20\x03(\x0b2\x12.hbb.CliprdrFormatR\x07formats\">\n\x1fCliprdrServ\
    erFormatListResponse\x12\x1b\n\tmsg_flags\x18\x02\x20\x01(\x05R\x08msgFl\
    ags\"P\n\x1eCliprdrServerFormatDataRequest\x12.\n\x13requested_format_id\
    \x18\x02\x20\x01(\x05R\x11requestedFormatId\"_\n\x1fCliprdrServerFormatD\
    ataResponse\x12\x1b\n\tmsg_flags\x18\x02\x20\x01(\x05R\x08msgFlags\x12\
    \x1f\n\x0bformat_data\x18\x03\x20\x01(\x0cR\nformatData\"\xb1\x02\n\x1aC\
    liprdrFileContentsRequest\x12\x1b\n\tstream_id\x18\x02\x20\x01(\x05R\x08\
    streamId\x12\x1d\n\nlist_index\x18\x03\x20\x01(\x05R\tlistIndex\x12\x19\
    \n\x08dw_flags\x18\x04\x20\x01(\x05R\x07dwFlags\x12$\n\x0en_position_low\
    \x18\x05\x20\x01(\x05R\x0cnPositionLow\x12&\n\x0fn_position_high\x18\x06\
    \x20\x01(\x05R\rnPositionHigh\x12!\n\x0ccb_requested\x18\x07\x20\x01(\
    ...
    .hbb.Auth2FAH\0R\x07auth2fa\x12A\n\x10multi_clipboards\x18\x1c\x20\x01(\
    \x0b2\x14.hbb.MultiClipboardsH\0R\x0fmultiClipboardsB\x07\n\x05union*\
    \x1c\n\x06Chroma\x12\x08\n\x04I420\x10\0\x12\x08\n\x04I444\x10\x01*<\n\
    \x0cKeyboardMode\x12\n\n\x06Legacy\x10\0\x12\x07\n\x03Map\x10\x01\x12\r\
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(FileRename::generated_message_descriptor_data());
