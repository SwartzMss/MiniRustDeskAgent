...
pub struct PunchHoleRequest {
    ...
    // @@protoc_insertion_point(field:hbb.PunchHoleRequest.version)
...
impl PunchHoleRequest {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "version",
            |m: &PunchHoleRequest| { &m.version },
            |m: &mut PunchHoleRequest| { &mut m.version },
        ));
...
pub struct PunchHoleResponse {
    ...
    // @@protoc_insertion_point(field:hbb.PunchHoleResponse.feedback)
    pub feedback: i32,
...
impl PunchHoleResponse {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "feedback",
            |m: &PunchHoleResponse| { &m.feedback },
            |m: &mut PunchHoleResponse| { &mut m.feedback },
        ));
...
impl ::protobuf::Message for PunchHoleResponse {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.feedback != 0 {
            my_size += ::protobuf::rt::int32_size(8, self.feedback);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.feedback != 0 {
            os.write_int32(8, self.feedback)?;
        }
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
                &punch_hole_response::Union::NatType(v) => {
...
pub struct RelayResponse {
    ...
    pub version: ::std::string::String,
    // @@protoc_insertion_point(field:hbb.RelayResponse.feedback)
    pub feedback: i32,
    // message oneof groups
...
impl RelayResponse {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "feedback",
            |m: &RelayResponse| { &m.feedback },
            |m: &mut RelayResponse| { &mut m.feedback },
        ));
...
impl ::protobuf::Message for RelayResponse {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.feedback != 0 {
            my_size += ::protobuf::rt::int32_size(9, self.feedback);
        }
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.feedback != 0 {
            os.write_int32(9, self.feedback)?;
        }
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
                &relay_response::Union::Id(ref v) => {
...
// @@protoc_insertion_point(message:hbb.HealthCheck)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct HealthCheck {
    // message fields
    // @@protoc_insertion_point(field:hbb.HealthCheck.token)
    pub token: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:hbb.HealthCheck.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
impl HealthCheck {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "token",
            |m: &HealthCheck| { &m.token },
            |m: &mut HealthCheck| { &mut m.token },
        ));
...
impl ::protobuf::MessageFull for HealthCheck {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        static descriptor: ::protobuf::rt::Lazy<::protobuf::reflect::MessageDescriptor> = ::protobuf::rt::Lazy::new();
        descriptor.get(|| file_descriptor().message_by_package_relative_name("HealthCheck").unwrap()).clone()
    }
}
...
impl RendezvousMessage {
    ...
    pub fn hc(&self) -> &HealthCheck {
        match self.union {
            ::std::option::Option::Some(rendezvous_message::Union::Hc(ref v)) => v,
            _ => <HealthCheck as ::protobuf::Message>::default_instance(),
        }
    }

    pub fn clear_hc(&mut self) {
        self.union = ::std::option::Option::None;
    }

    pub fn has_hc(&self) -> bool {
        match self.union {
            ::std::option::Option::Some(rendezvous_message::Union::Hc(..)) => true,
            _ => false,
        }
    }

    // Param is passed by value, moved
    pub fn set_hc(&mut self, v: HealthCheck) {
        self.union = ::std::option::Option::Some(rendezvous_message::Union::Hc(v))
    }

    // Mutable pointer to the field.
    pub fn mut_hc(&mut self) -> &mut HealthCheck {
        if let ::std::option::Option::Some(rendezvous_message::Union::Hc(_)) = self.union {
        } else {
            self.union = ::std::option::Option::Some(rendezvous_message::Union::Hc(HealthCheck::new()));
        }
        match self.union {
            ::std::option::Option::Some(rendezvous_message::Union::Hc(ref mut v)) => v,
            _ => panic!(),
        }
    }

    // Take field
    pub fn take_hc(&mut self) -> HealthCheck {
        if self.has_hc() {
            match self.union.take() {
                ::std::option::Option::Some(rendezvous_message::Union::Hc(v)) => v,
                _ => panic!(),
            }
        } else {
            HealthCheck::new()
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_oneof_message_has_get_mut_set_accessor::<_, HealthCheck>(
            "hc",
            RendezvousMessage::has_hc,
            RendezvousMessage::hc,
            RendezvousMessage::mut_hc,
            RendezvousMessage::set_hc,
        ));
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                210 => {
                    self.union = ::std::option::Option::Some(rendezvous_message::Union::Hc(is.read_message()?));
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        ...
        if let ::std::option::Option::Some(ref v) = self.union {
            match v {
                ...
                &rendezvous_message::Union::Hc(ref v) => {
                    let len = v.compute_size();
                    my_size += 2 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
                },
            };
...
pub mod rendezvous_message {
    ...
    pub enum Union {
        ...
        // @@protoc_insertion_point(oneof_field:hbb.RendezvousMessage.hc)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    Type\x12\x14\n\x05token\x18\x05\x20\x01(\tR\x05token\x12\x18\n\x07versio\
    n\x18\x06\x20\x01(\tR\x07version\"x\n\tPunchHole\x12\x1f\n\x0bsocket_add\
    r\x18\x01\x20\x01(\x0cR\nsocketAddr\x12!\n\x0crelay_server\x18\x02\x20\
    \x01(\tR\x0brelayServer\x12'\n\x08nat_type\x18\x03\x20\x01(\x0e2\x0c.hbb\
    .NatTypeR\x07natType\"(\n\x0eTestNatRequest\x12\x16\n\x06serial\x18\x01\
    \x20\x01(\x05R\x06serial\"H\n\x0fTestNatResponse\x12\x12\n\x04port\x18\
    \x01\x20\x01(\x05R\x04port\x12!\n\x02cu\x18\x02\x20\x01(\x0b2\x11.hbb.Co\
    nfigUpdateR\x02cu\"\xa6\x01\n\rPunchHoleSent\x12\x1f\n\x0bsocket_addr\
    \x18\x01\x20\x01(\x0cR\nsocketAddr\x12\x0e\n\x02id\x18\x02\x20\x01(\tR\
    \x02id\x12!\n\x0crelay_server\x18\x03\x20\x01(\tR\x0brelayServer\x12'\n\
    \x08nat_type\x18\x04\x20\x01(\x0e2\x0c.hbb.NatTypeR\x07natType\x12\x18\n\
    \x07version\x18\x05\x20\x01(\tR\x07version\"W\n\nRegisterPk\x12\x0e\n\
    \x02id\x18\x01\x20\x01(\tR\x02id\x12\x12\n\x04uuid\x18\x02\x20\x01(\x0cR\
    \x04uuid\x12\x0e\n\x02pk\x18\x03\x20\x01(\x0cR\x02pk\x12\x15\n\x06old_id\
    \x18\x04\x20\x01(\tR\x05oldId\"\xeb\x01\n\x12RegisterPkResponse\x126\n\
    \x06result\x18\x01\x20\x01(\x0e2\x1e.hbb.RegisterPkResponse.ResultR\x06r\
    esult\x12\x1d\n\nkeep_alive\x18\x02\x20\x01(\x05R\tkeepAlive\"~\n\x06Res\
    ult\x12\x06\n\x02OK\x10\0\x12\x11\n\rUUID_MISMATCH\x10\x02\x12\r\n\tID_E\
    XISTS\x10\x03\x12\x10\n\x0cTOO_FREQUENT\x10\x04\x12\x15\n\x11INVALID_ID_\
    FORMAT\x10\x05\x12\x0f\n\x0bNOT_SUPPORT\x10\x06\x12\x10\n\x0cSERVER_ERRO\
    R\x10\x07\"\x88\x03\n\x11PunchHoleResponse\x12\x1f\n\x0bsocket_addr\x18\
    \x01\x20\x01(\x0cR\nsocketAddr\x12\x0e\n\x02pk\x18\x02\x20\x01(\x0cR\x02\
    pk\x128\n\x07failure\x18\x03\x20\x01(\x0e2\x1e.hbb.PunchHoleResponse.Fai\
    lureR\x07failure\x12!\n\x0crelay_server\x18\x04\x20\x01(\tR\x0brelayServ\
    er\x12)\n\x08nat_type\x18\x05\x20\x01(\x0e2\x0c.hbb.NatTypeH\0R\x07natTy\
    pe\x12\x1b\n\x08is_local\x18\x06\x20\x01(\x08H\0R\x07isLocal\x12#\n\roth\
    er_failure\x18\x07\x20\x01(\tR\x0cotherFailure\x12\x1a\n\x08feedback\x18\
    \x08\x20\x01(\x05R\x08feedback\"S\n\x07Failure\x12\x10\n\x0cID_NOT_EXIST\
    \x10\0\x12\x0b\n\x07OFFLINE\x10\x02\x12\x14\n\x10LICENSE_MISMATCH\x10\
    \x03\x12\x13\n\x0fLICENSE_OVERUSE\x10\x04B\x07\n\x05union\"U\n\x0cConfig\
    Update\x12\x16\n\x06serial\x18\x01\x20\x01(\x05R\x06serial\x12-\n\x12ren\
    dezvous_servers\x18\x02\x20\x03(\tR\x11rendezvousServers\"\xf1\x01\n\x0c\
    RequestRelay\x12\x0e\n\x02id\x18\x01\x20\x01(\tR\x02id\x12\x12\n\x04uuid\
    \x18\x02\x20\x01(\tR\x04uuid\x12\x1f\n\x0bsocket_addr\x18\x03\x20\x01(\
    \x0cR\nsocketAddr\x12!\n\x0crelay_server\x18\x04\x20\x01(\tR\x0brelaySer\
    ver\x12\x16\n\x06secure\x18\x05\x20\x01(\x08R\x06secure\x12\x1f\n\x0blic\
    ence_key\x18\x06\x20\x01(\tR\nlicenceKey\x12*\n\tconn_type\x18\x07\x20\
    \x01(\x0e2\r.hbb.ConnTypeR\x08connType\x12\x14\n\x05token\x18\x08\x20\
    \x01(\tR\x05token\"\xef\x01\n\rRelayResponse\x12\x1f\n\x0bsocket_addr\
    \x18\x01\x20\x01(\x0cR\nsocketAddr\x12\x12\n\x04uuid\x18\x02\x20\x01(\tR\
    \x04uuid\x12!\n\x0crelay_server\x18\x03\x20\x01(\tR\x0brelayServer\x12\
    \x10\n\x02id\x18\x04\x20\x01(\tH\0R\x02id\x12\x10\n\x02pk\x18\x05\x20\
    \x01(\x0cH\0R\x02pk\x12#\n\rrefuse_reason\x18\x06\x20\x01(\tR\x0crefuseR\
    eason\x12\x18\n\x07version\x18\x07\x20\x01(\tR\x07version\x12\x1a\n\x08f\
    eedback\x18\t\x20\x01(\x05R\x08feedbackB\x07\n\x05union\"\"\n\x0eSoftwar\
    eUpdate\x12\x10\n\x03url\x18\x01\x20\x01(\tR\x03url\"T\n\x0eFetchLocalAd\
    dr\x12\x1f\n\x0bsocket_addr\x18\x01\x20\x01(\x0cR\nsocketAddr\x12!\n\x0c\
    relay_server\x18\x02\x20\x01(\tR\x0brelayServer\"\x98\x01\n\tLocalAddr\
    \x12\x1f\n\x0bsocket_addr\x18\x01\x20\x01(\x0cR\nsocketAddr\x12\x1d\n\nl\
    ocal_addr\x18\x02\x20\x01(\x0cR\tlocalAddr\x12!\n\x0crelay_server\x18\
    \x03\x20\x01(\tR\x0brelayServer\x12\x0e\n\x02id\x18\x04\x20\x01(\tR\x02i\
    d\x12\x18\n\x07version\x18\x05\x20\x01(\tR\x07version\"\xab\x01\n\rPeerD\
    iscovery\x12\x10\n\x03cmd\x18\x01\x20\x01(\tR\x03cmd\x12\x10\n\x03mac\
    \x18\x02\x20\x01(\tR\x03mac\x12\x0e\n\x02id\x18\x03\x20\x01(\tR\x02id\
    ...
    ates\x18\x01\x20\x01(\x0cR\x06states\"!\n\x0bKeyExchange\x12\x12\n\x04ke\
    ys\x18\x01\x20\x03(\x0cR\x04keys\"#\n\x0bHealthCheck\x12\x14\n\x05token\
    \x18\x01\x20\x01(\tR\x05token\"\xad\n\n\x11RendezvousMessage\x128\n\rreg\
    ister_peer\x18\x06\x20\x01(\x0b2\x11.hbb.RegisterPeerH\0R\x0cregisterPee\
    r\x12Q\n\x16register_peer_response\x18\x07\x20\x01(\x0b2\x19.hbb.Registe\
    rPeerResponseH\0R\x14registerPeerResponse\x12E\n\x12punch_hole_request\
    ...
    eH\0R\x0bkeyExchange\x12\"\n\x02hc\x18\x1a\x20\x01(\x0b2\x10.hbb.HealthC\
    heckH\0R\x02hcB\x07\n\x05union*J\n\x08ConnType\x12\x10\n\x0cDEFAULT_CONN\
